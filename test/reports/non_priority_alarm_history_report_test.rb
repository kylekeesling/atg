...
class NonPriorityAlarmHistoryReportTest < Minitest::Test
  def test_non_priority_alarm_history_report
    entries = report_response(Atg::NonPriorityAlarmHistoryReport)
